...
<img align="right" src="images/Cantor_Georg_German.jpg" width="15%" />
...
<img align="right" src="images/Boole_George_English.jpg" width="15%" />
...
<img align="right" src="images/Carathéodory_Constantin_Greek.jpg" width="20%" />
...
<img align="right" src="images/Lebesgue_Henri_French.jpg" width="20%" />
...
<img align="right" src="images/Kolmogorov_Andrey_Russian.jpg" width="20%" />
...
<img align="right" src="images/Fréchet_Maurice_French.jpg" width="20%" />
...
An equivalent definition is, given a probability space, a <span style="color:purple;">random function</span> is a mesurable function from the product space of the sample space and an index set to the real line, which means, it is a function of two variables. 
...
- If $T = \mathbb{N}$, $X$ is a <span style="color:purple;">random sequence</span>.
